...
class _QuizScreen extends State<QuizScreen> {
    ...
    Widget build(BuildContext context) {
      ...
      int getIndex(int numberIndexLeft) {
        ...
        if (y == 0)
          rightAnswerNumberIndexLeft = numberIndexLeft;
            ...
            children: [
              ...
              GridView.count(
                  ...
                  children: [
                    ...
                    Container(
                      child: Image.asset("images/female_teacher_1.png",scale: 0.8,),
                    )
                  ],
              ),
              Stack(
                children: [
                  Align(
                    ...
                    child: Image.asset("images/exam_paper.png",),
                  ),
                  GridView.count(
                      crossAxisCount: 5,
                      ...
                      children: [
                        ...
                        InkWell(
                          child: Text(
                            ...
                            style: TextStyle(backgroundColor: choice4,fontSize: 32),
                          ),
                          onTap: () {
                        ...
                        InkWell(
                          child: Text(
                            ...
                            style: TextStyle(backgroundColor: choice3,fontSize: 32),
                          ),
                          onTap: () {
                        ...
                        InkWell(
                          child: Text(
                            ...
                            style: TextStyle(backgroundColor: choice2,fontSize: 32),
                          ),
                          onTap: () {
                        ...
                        InkWell(
                          child: Text(
                            ...
                            style: TextStyle(backgroundColor: choice1,fontSize: 32),
                          ),
                          onTap: () {
