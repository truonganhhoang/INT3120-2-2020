...
class _KienThucScreen extends State<KienThucScreen> {
  ...
  getData(int number1,String calculation) async {
    ...
    if (calculation == "divide") {
      res = await  db.query(calculation, where: "result = ?", whereArgs: [number1]);
    }
    else {
      res = await  db.query(calculation, where: "number1 = ?", whereArgs: [number1]);
    }
  ...
  Widget build(BuildContext context) {
    ...
    maps.forEach((element) {
      ...
      list.add(
        (element['number1'].toString() + calculateIcon + element['number2'].toString() + " = " + element['result'].toString() +"   "),
      );
      ++count;
    }
    );
    ...
    if (maps.isEmpty) {
      if (widget.calculation == "plus") {
        calculationSet = "_ + 1 = _   _ + 2 = _ \n\n_ + 3 = _   _ + 4 = _ \n\n_ + 5 = _   _ + 6 = _ \n\n_ + 7 = _   _ + 8 = _ \n\n_ + 9 = _   _ + 10 = _";
      }
      else if (widget.calculation == "minus") {
        calculationSet = "_ - 1 = _   _ - 2 = _ \n\n_ - 3 = _   _ - 4 = _ \n\n_ - 5 = _   _ - 6 = _ \n\n_ - 7 = _   _ - 8 = _ \n\n_ - 9 = _   _ - 10 = _";
      }
      else if (widget.calculation == "duplicate") {
        calculationSet = "_ x 1 = _   _ x 2 = _ \n\n_ x 3 = _   _ x 4 = _ \n\n_ x 5 = _   _ x 6 = _ \n\n_ x 7 = _   _ x 8 = _ \n\n_ x 9 = _   _ x 10 = _";
      }
      else if (widget.calculation == "divide") {
        calculationSet = "_ : 1 = _   _ : 2 = _ \n\n_ : 3 = _   _ : 4 = _ \n\n_ : 5 = _   _ : 6 = _ \n\n_ : 7 = _   _ : 8 = _ \n\n_ : 9 = _   _ : 10 = _";
      }
          ...
          child: GridView.count(
              ...
              children: [
                Stack(
                  children: [
                    InkWell(
                      child: Image.asset("images/back_image.png",scale: 1.5,),
                      onTap: (){
                ...
                Align(
                  ...
                  child: Image.asset("images/talk_bubble_kienthuc.png",),
                ),
                Stack(
                  children: [
                    Align(
                    ...
                    Align(
                      ...
                      child: Text('Section',style: TextStyle(fontSize: 24),),
                    ),
                    GridView.count(
                      crossAxisCount: 6,
