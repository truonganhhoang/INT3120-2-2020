  ...
  Widget build(BuildContext context) {
    return Column(children: <Widget>[
      ...
      Container(
        ...
        decoration: new BoxDecoration(border: Border.all(color: Colors.green)),
        child: Column(
          children: [
            Row(children: [
              Expanded(
            ...
            Row(children: [
              ...
              Align(
                  alignment: Alignment.centerLeft,
                  child:
                      Text('600,000đ', style: TextStyle(color: Colors.black))),
            ]),
            Row(children: [
              Align(
                  alignment: Alignment.centerLeft,
            ...
            Row(children: [
              Align(
                  alignment: Alignment.centerLeft,
                  child:
                      Text('Hình thức: ', style: TextStyle(color: Colors.red))),
              Align(
                  alignment: Alignment.centerLeft,
                  child:
      ...
      Align(
        ...
        child: FloatingActionButton(
            ...
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => NewOrderTeacher()),
              );
            }),
      ),
    ]);
